...
## [0.6.4](https://github.com/overrealdb/oversync/compare/oversync-v0.6.3...oversync-v0.6.4) - 2026-04-14

### Other

- *(logging)* add startup tracing around engine init and schema apply
