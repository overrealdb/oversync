...
fn navigate_path<'a>(value: &'a serde_json::Value, path: &str) -> &'a serde_json::Value {
...
fn items_to_rows(items: &[serde_json::Value], key_column: &str) -> Result<Vec<RawRow>, OversyncError> {
