...
pub mod config_version {
	...
	pub const GET_VERSION: &str =
		include_str!("../surql/queries/config_version/get_version.surql");
...
pub mod mutations {
	...
	pub const LOCK_RELEASE: &str =
		include_str!("../surql/queries/mutations/lock_release.surql");
